...
namespace MapApplication.Migrations
{
    ...
    [Migration("20240821134018_UpdateSchema3")]
            ...
            modelBuilder.Entity("MapApplication.Data.FeatureDb", b =>
                {
                    ...
                    b.Property<int?>("OwnerShapeIdForPoint")
                        .HasColumnType("integer")
                        .HasColumnName("ownerShapeIdForPoint");

                    b.Property<int?>("OwnerShapeIdForWkt")
                        .HasColumnType("integer")
                        .HasColumnName("ownerShapeIdForWkt");

                    b.Property<string>("OwnerShapeType")
                        .IsRequired()
                        .HasColumnType("text")
                    ...
                    b.HasIndex("OwnerShapeIdForPoint");

                    b.HasIndex("OwnerShapeIdForWkt");
            ...
            modelBuilder.Entity("MapApplication.Data.FeatureDb", b =>
                {
                    b.HasOne("MapApplication.Data.PointDb", null)
                        .WithMany("Features")
                        .HasForeignKey("OwnerShapeIdForPoint")
                        .OnDelete(DeleteBehavior.Cascade)
                        .HasConstraintName("FK_Features_Points_OwnerShapeId");

                    b.HasOne("MapApplication.Data.WktDb", null)
                        .WithMany("Features")
                        .HasForeignKey("OwnerShapeIdForWkt")
